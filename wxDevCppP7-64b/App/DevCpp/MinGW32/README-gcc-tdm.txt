...
REQUIRED BASE:
 * gcc-core (gcc-4.6.1-tdm-1-core)
 * binutils (binutils-2.21.53-1-mingw32-bin)
 * mingwrt (mingwrt-3.20-mingw32-dev, mingwrt-3.20-mingw32-dll)
 * w32api (w32api-3.17-2-mingw32-dev)

OPTIONAL:
 * gcc-c++ (gcc-4.6.1-tdm-1-c++) - C++ support
 * gcc-ada (gcc-4.6.1-tdm-1-ada) - Ada support
 * gcc-fortran (gcc-4.6.1-tdm-1-fortran) - Fortran support
 * gcc-objc (gcc-4.6.1-tdm-1-objc) - Objective-C/C++ support
 * gcc-openmp (gcc-4.6.1-tdm-1-openmp) - OpenMP support
 ...
 * gdb (gdb-7.3-2-mingw32-bin, libexpat-2.0.1-1-mingw32-dll-1) - GNU
